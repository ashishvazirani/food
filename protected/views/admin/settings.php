...
<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Website Logo")?></label>
...
<p class="uk-text-muted"><?php echo Yii::t("default","Website logo 334x56")?></p>
...
<h2><?php echo Yii::t("default","Receipt Logo")?></h2>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Nos. of days merchant can change the order status")?></label>  
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Search As PostCode")?></label>
  <?php 
  echo CHtml::radioButton('home_search_mode',
