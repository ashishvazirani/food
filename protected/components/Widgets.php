...
class Widgets extends CApplicationComponent
{
	...
	public function searchByCuisine()
	{
		...
		<div class="search-box-wrap">	       
	       <a href="javascript:;">
	       <h4 class="left"><?php echo Yii::t("default","Choose Cuisine")?></h4> <i class="right fa fa-caret-up"></i>
	       <div class="clear"></div>
	       </a>
	...
	public static function applyVoucher($merchant_id='')
	{
		...
		$text=Yii::t("default","Use Voucher");
         if (isset($_SESSION['voucher_code'])){		         	
         	if (is_array($_SESSION['voucher_code'])){		         		
         		$has_voucher=true;         		
         		$style="display:none;";
         		$code=$_SESSION['voucher_code']['voucher_code'];
        ...
        <a href="javascript:;" class="uk-button uk-button-danger apply_voucher"><?php echo $text?></a>            
        </div>
		<?php
	}
 ...
 <?php echo Yii::t("default","View Map")?></a>
	...
	{		
		...
		<?php foreach ($menu as $val): //dump($val);?>
		  ...
		  ?>
           <a href="javascript:;" rel="<?php echo $item['item_id']?>" class="menu-item" 
