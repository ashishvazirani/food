...
<a href="<?php echo Yii::app()->createUrl('admin/merchantcommission',array('query'=>"month","date"=>$key))?>" class="uk-button selected_transaction_query <?php echo "selected-".$key;?>"><?php echo $months_val?></a>
<?php endforeach;?>
<?php endif;?>
